...
GENERATE_VECTOR_TESTS(TinyVector)

GENERATE_VECTOR_TESTS(FlatVector)
GENERATE_VECTOR_TESTS(TinyFlatVector)

GENERATE_SMALL_VECTOR_TESTS(SmallVector)
GENERATE_SMALL_VECTOR_TESTS(TinySmallVector)

GENERATE_ALLOCATED_VECTOR_TESTS(AllocatedVector)
GENERATE_ALLOCATED_VECTOR_TESTS(AllocatedTinyVector)

GENERATE_ALLOCATED_VECTOR_TESTS(AllocatedFlatVector)
GENERATE_ALLOCATED_VECTOR_TESTS(AllocatedTinyFlatVector)

GENERATE_ALLOCATED_SMALL_VECTOR_TESTS(AllocatedSmallVector)
GENERATE_ALLOCATED_SMALL_VECTOR_TESTS(AllocatedTinySmallVector)
