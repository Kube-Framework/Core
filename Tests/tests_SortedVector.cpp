...
GENERATE_VECTOR_TESTS(SortedTinyVector, NO_ALLOCATOR)

GENERATE_VECTOR_TESTS(SortedFlatVector, NO_ALLOCATOR)
GENERATE_VECTOR_TESTS(SortedTinyFlatVector, NO_ALLOCATOR)

GENERATE_VECTOR_TESTS(SortedSmallVector, NO_ALLOCATOR, 4)
GENERATE_VECTOR_TESTS(SortedTinySmallVector, NO_ALLOCATOR, 4)

GENERATE_VECTOR_TESTS(SortedAllocatedVector, ALLOCATOR)
GENERATE_VECTOR_TESTS(SortedAllocatedTinyVector, ALLOCATOR)

GENERATE_VECTOR_TESTS(SortedAllocatedFlatVector, ALLOCATOR)
GENERATE_VECTOR_TESTS(SortedAllocatedTinyFlatVector, ALLOCATOR)

GENERATE_VECTOR_TESTS(SortedAllocatedSmallVector, ALLOCATOR, 4)
GENERATE_VECTOR_TESTS(SortedAllocatedTinySmallVector, ALLOCATOR, 4)